...
const projects = [
    ...
    },
    {
        ...
        author: '인디 게임 팀',
        authorId: 'dev6',
        description: '시간 여행을 소재로 한 로맨스 어드벤처 게임의 시나리오가 필요합니다.',
        fullDescription: '과거와 현재를 오가며 사랑을 찾는 시간 여행 어드벤처입니다. 선택에 따라 다른 시대의 인물과 관계를 맺을 수 있습니다.',
        requirements: '메인 스토리, 로맨스 분기, 시대별 대사',
        tags: ['로맨스', '시간여행', '어드벤처', '선택'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '현대와 조선시대를 오가는 시간의 문. 특정 조건에서만 열리는 차원의 틈.',
            characters: '주인공: 시간 여행 능력을 깨달은 대학생 / 조력자: 시간 수호자, 역사학자 / 적대자: 시간을 조작하려는 세력.',
            structure: '현재(능력 발견) → 과거 여행 → 관계 형성 → 위기 → 선택 → 엔딩',
            tone: '따뜻하고 감성적인 로맨스. 드라마 "구미호뎐" 스타일.'
        }
    },
    {
        id: 7,
        ...
        author: '전략 게임 개발사',
        authorId: 'dev7',
        description: '판타지 세계관의 턴제 전략 게임에 필요한 스토리와 캐릭터 설정',
        fullDescription: '마법과 검술이 공존하는 판타지 대륙에서 벌어지는 국가 간 전쟁을 다룬 턴제 전략 게임입니다.',
        requirements: '세계관 설정, 국가별 배경, 캐릭터 스토리',
        tags: ['전략', '판타지', '전쟁', '턴제'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '5개 국가가 대립하는 대륙. 각 국가는 고유한 마법 체계를 보유.',
            characters: '주인공: 소국 출신 장군 / 조력자: 각국 대사, 마법사 고문 / 적대자: 제국 황제.',
            structure: '튜토리얼 전투 → 외교 → 전쟁 확전 → 최종 결전 → 국가별 엔딩',
            tone: '진지하고 전략적인 분위기. "파이어 엠블럼" 시리즈 레퍼런스.'
        }
    },
    {
        id: 8,
        ...
        author: '모바일 게임사',
        authorId: 'dev8',
        description: '캐주얼 퍼즐 게임에 삽입할 짧고 재미있는 스토리 에피소드',
        fullDescription: '매일 새로운 퍼즐을 풀며 진행되는 스토리 모드. 각 스테이지마다 작은 이야기가 연결됩니다.',
        requirements: '짧은 에피소드 스토리, 캐릭터 대사',
        tags: ['퍼즐', '캐주얼', '모바일', '에피소드'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '마법의 섬에서 벌어지는 모험. 각 섬은 다른 테마의 퍼즐을 담고 있음.',
            characters: '주인공: 모험가 / 조력자: 마법 고양이, 섬의 수호자들',
            structure: '섬1(튜토리얼) → 섬2~10(에피소드) → 최종 섬(보스)',
            tone: '가볍고 유쾌한 분위기. 애니메이션 "포켓몬" 스타일.'
        }
    },
    {
        id: 9,
        ...
        author: '호러 게임 스튜디오',
        authorId: 'dev9',
        description: '자원 관리와 생존이 핵심인 호러 게임의 스토리 라인',
        fullDescription: '좀비 아포칼립스 상황에서 생존하며 진실을 찾아가는 게임입니다. 자원 관리와 선택이 스토리에 영향을 줍니다.',
        requirements: '생존 이벤트, 선택 분기, 엔딩 시나리오',
        tags: ['호러', '생존', '좀비', '선택'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '바이러스로 인해 좀비가 된 세계. 안전 지대와 위험 지역이 구분됨.',
            characters: '주인공: 생존자 / 조력자: 의사, 엔지니어 / 적대자: 좀비, 다른 생존자 그룹.',
            structure: '바이러스 발발 → 탈출 → 안전 기지 → 진실 탐구 → 최종 선택',
            tone: '긴장감 넘치는 공포. "더 라스트 오브 어스" 레퍼런스.'
        }
    },
    {
        id: 10,
        title: '학교 생활 시뮬레이션 스토리',
        genre: '시뮬레이션',
        author: '시뮬레이션 게임 개발팀',
        authorId: 'dev10',
        description: '고등학교 생활을 시뮬레이션하는 게임의 스토리와 이벤트',
        fullDescription: '고등학교 3년간의 생활을 체험하는 시뮬레이션 게임입니다. 공부, 친구, 연애 등 다양한 요소가 있습니다.',
        requirements: '이벤트 스토리, 캐릭터 대화, 엔딩 분기',
        tags: ['시뮬레이션', '학교', '일상', '성장'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '일반적인 고등학교. 계절별 이벤트와 학년별 스토리가 존재.',
            characters: '주인공: 고등학생 / 조력자: 친구들, 선생님 / 적대자: 라이벌 학생.',
            structure: '1학년(적응) → 2학년(성장) → 3학년(선택) → 졸업 엔딩',
            tone: '밝고 청춘다운 분위기. "도라에몽" 스타일의 일상물.'
        }
    },
    {
        id: 11,
        ...
        author: '무협 게임 제작사',
        authorId: 'dev11',
        description: '중국 무협 세계관을 배경으로 한 RPG 게임의 메인 스토리',
        fullDescription: '무림에서 벌어지는 복수와 성장의 이야기입니다. 각 문파의 비밀과 주인공의 정체가 점차 밝혀집니다.',
        requirements: '무협 세계관, 문파 설정, 복선과 반전',
        tags: ['무협', 'RPG', '복수', '성장'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '중국 고대 무림. 정파와 사파가 대립하며 각 문파가 고유한 무공을 보유.',
            characters: '주인공: 복수를 다짐한 무인 / 조력자: 각 문파의 고수들 / 적대자: 주인공 가문을 멸한 세력.',
            structure: '가문 멸망 → 수련 → 진실 발견 → 복수 → 선택',
            tone: '장엄하고 비장한 무협물. "천룡팔부" 스타일.'
        }
    },
    {
        id: 12,
        ...
        author: '액션 게임 개발팀',
        authorId: 'dev12',
        description: '거대 로봇을 조종하는 액션 게임의 스토리와 캐릭터',
        fullDescription: '외계 침략에 맞서 거대 로봇으로 전투하는 액션 게임입니다. 각 로봇마다 고유한 스토리가 있습니다.',
        requirements: '로봇 설정, 전투 대사, 스토리 모드',
        tags: ['액션', '로봇', 'SF', '전투'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '미래 지구. 외계 생명체의 침략에 맞서 거대 로봇으로 방어.',
            characters: '주인공: 로봇 파일럿 / 조력자: 다른 파일럿들, 과학자 / 적대자: 외계 생명체.',
            structure: '침략 시작 → 첫 전투 → 로봇 업그레이드 → 최종 전투',
            tone: '역동적이고 박진감 넘치는 액션. "에반게리온" 레퍼런스.'
        }
    },
    {
        id: 13,
        ...
        author: '캐주얼 게임 개발팀',
        authorId: 'dev13',
        description: '레스토랑을 운영하는 시뮬레이션 게임의 스토리와 이벤트',
        fullDescription: '작은 레스토랑에서 시작해 세계적인 레스토랑 체인을 만드는 시뮬레이션 게임입니다.',
        requirements: '레시피 스토리, 고객 이벤트, 성장 스토리',
        tags: ['시뮬레이션', '요리', '경영', '성장'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '현대 도시. 각 지역마다 다른 음식 문화가 존재하며 경쟁 레스토랑들이 있음.',
            characters: '주인공: 요리사 지망생 / 조력자: 셰프, 고객들 / 적대자: 경쟁 레스토랑.',
            structure: '작은 가게 → 확장 → 프랜차이즈 → 세계 진출',
            tone: '따뜻하고 유쾌한 분위기. "쿠킹 마마" 스타일.'
        }
    },
    {
        id: 14,
        ...
        author: '모바일 RPG 개발사',
        authorId: 'dev14',
        description: '모바일 판타지 RPG의 메인 퀘스트와 서브 스토리',
        fullDescription: '전통적인 판타지 세계관에서 모험을 떠나는 RPG입니다. 다양한 퀘스트와 캐릭터 스토리가 있습니다.',
        requirements: '메인 퀘스트, 서브 퀘스트, 캐릭터 스토리',
        tags: ['RPG', '판타지', '모바일', '모험'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '마법과 검술이 공존하는 판타지 대륙. 각 지역마다 다른 문화와 몬스터.',
            characters: '주인공: 모험가 / 조력자: 파티원들, NPC / 적대자: 다크 로드.',
            structure: '시작 마을 → 던전 탐험 → 세계 여행 → 최종 던전',
            tone: '전통적인 판타지 RPG. "드래곤 퀘스트" 스타일.'
        }
    },
    {
        id: 15,
        title: '추리 미스터리 비주얼 노벨',
        genre: '비주얼 노벨',
        author: 'VN 스튜디오',
        authorId: 'dev15',
        description: '추리 게임 형식의 비주얼 노벨 시나리오',
        fullDescription: '연쇄 살인 사건을 추리하는 비주얼 노벨입니다. 증거를 수집하고 진범을 찾아냅니다.',
        requirements: '추리 스토리, 단서 설정, 반전',
        tags: ['추리', '미스터리', '비주얼 노벨', '반전'],
        applications: [],
        ownerRole: 'producer',
        templateDetails: {
            worldview: '현대 도시. 연쇄 살인 사건이 발생하며 경찰과 주인공이 수사.',
            characters: '주인공: 추리 작가 / 조력자: 경찰, 조사관 / 적대자: 진범.',
            structure: '사건 발생 → 단서 수집 → 용의자 조사 → 진범 추적 → 반전',
            tone: '긴장감 넘치는 추리물. "역전재판" 스타일.'
        }
    }
];
...
function searchProjects() {
    ...
    filteredProjects = allProjects.filter(project => {
        ...
        const authorText = project.author ? project.author.toLowerCase() : '';
        ...
        const matchKeyword = !keyword || 
            ...
            (project.tags && project.tags.some(tag => tag && tag.toLowerCase().includes(keyword))) ||
    ...
    if (keyword || genre) {
        ...
        if (resultCount === 0) {
            ...
            console.log(`${resultCount}개의 프로젝트를 찾았습니다.`);
        }
    }
}
...
function updateMakerPageCopy() {
    ...
    const makersLink = document.getElementById('makersLink');
    const makersNavBtn = document.getElementById('makersNavBtn');
    ...
    if (currentUser.role === 'writer') {
        ...
        if (makersLink) makersLink.textContent = '제작자 찾기';
        if (makersNavBtn) makersNavBtn.textContent = '제작자';
        if (makerSearchInput) makerSearchInput.placeholder = '제작자 이름, 프로젝트, 강점으로 검색';
    } else if (currentUser.role === 'producer') {
        titleEl.textContent = '시나리오 작가를 찾아보세요';
        subtitleEl.textContent = '장르/스타일별로 작가를 검색하고 연락해보세요.';
        if (makersLink) makersLink.textContent = '작가 찾기';
        if (makersNavBtn) makersNavBtn.textContent = '작가';
        if (makerSearchInput) makerSearchInput.placeholder = '작가 이름, 소개, 스킬로 검색';
    } else {
        titleEl.textContent = '시나리오 파트너 찾기';
        subtitleEl.textContent = '로그인하면 역할에 맞춘 팀원을 추천받을 수 있어요.';
        if (makersLink) makersLink.textContent = '팀원 찾기';
        if (makersNavBtn) makersNavBtn.textContent = '팀원';
        if (makerSearchInput) makerSearchInput.placeholder = '이름, 소개, 스킬로 검색';
    }
}
...
function renderMakers() {
    ...
    const listType = currentUser.role === 'writer' ? 'producer'
        : currentUser.role === 'producer' ? 'writer' : 'writer';
    ...
    filtered.forEach((maker, index) => {
        ...
        const icon = listType === 'producer' ? '🎮' : '✍️';
        
        card.innerHTML = `
            <div class="maker-avatar maker-card-avatar">${icon}</div>
            <h3>${maker.name}</h3>
...
function showMakerDetail(index) {
    ...
    if (avatarEl) {
        const icon = currentUser.role === 'writer' ? '🎮' : '✍️';
...
function updateDashboard() {
    ...
    if (avatarEl) {
        if (currentUser.isLoggedIn) {
            avatarEl.textContent = currentUser.role === 'writer' ? '✍️' : '🎮';
        } else {
...
function renderApplications() {
    ...
    if (!currentUser.isLoggedIn) {
        list.innerHTML = `
            <div class="empty-state">
                <div class="icon">🔐</div>
                <h3>로그인 후 받은 지원/제안을 확인할 수 있습니다</h3>
            </div>
        `;
...
function renderMyApplications() {
    ...
    if (!currentUser.isLoggedIn) {
        list.innerHTML = `
            <div class="empty-state">
                <div class="icon">🔐</div>
                <h3>로그인 후 내가 지원한 내역을 확인할 수 있습니다</h3>
            </div>
        `;
        currentMyApplicationsView = [];
        return;
    }
